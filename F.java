        ...
        public static ComputationGraphConfiguration.GraphBuilder createGeneratorConfig(int noiseSize, int hiddenSize, int maxTrajLen) {
            return new NeuralNetConfiguration.Builder()
                    ...
                    .addLayer("convTrans1", new Convolution1DLayer.Builder()
                            ...
                            .activation(Activation.RELU)
                            .build(), "lambda")
                    .addLayer("batchNorm1", new BatchNormalization.Builder().nIn(hiddenSize).nOut(hiddenSize).build(), "convTrans1")
                    .addLayer("convTrans2", new Convolution1DLayer.Builder()
                            ...
                            .activation(Activation.RELU)
                            .build(), "batchNorm1")
                    .addLayer("batchNorm2", new BatchNormalization.Builder().nIn(hiddenSize).nOut(hiddenSize).build(), "convTrans2")
